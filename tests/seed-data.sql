...
INSERT INTO translation_sessions (id, user_id, repository, language_code, started_at) VALUES
                                                                                          ('session-alice-fr', 'user-alice-123', 'melodylumen/social-app', 'fr', datetime('now', '-2 hours')),
                                                                                          ('session-bob-es', 'user-bob-456', 'melodylumen/social-app', 'es', datetime('now', '-1 hour')),
                                                                                          ('session-alice-cr', 'user-alice-123', 'melodylumen/social-app', 'cr', datetime('now', '-30 minutes'));
